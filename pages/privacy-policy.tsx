const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Novus.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Novus, accessible from{' '}
            <a
              href='https://www.novuspkg.com/'
              rel='external nofollow noopener noreferrer'
              target='_blank'
            >
              https://www.novuspkg.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Google Analytics.</strong> The Website also has enabled the
          Google Analytics Advertising features, which allows Google to collect
          data about users on Our Website via Google advertising cookies and
          anonymous identifiers, in addition to standard Google Analytics data.
          You may choose to opt out of this by downloading and installing the
          Google Analytics opt-out add-on here
